...
preferences {
    ...
    section ("InfluxDB Database:") {
        input "prefDatabaseHost", "text", title: "Host", defaultValue: "192.168.1.20", required: true
        ...
        input "prefDatabaseUser", "text", title: "Username", defaultValue: "grafana", required: true
        input "prefDatabasePass", "text", title: "Password", defaultValue: "Not24Get", required: true
    }
...
private getGroupName(id) {
    ...
    else if (id == '324aa5a1-59e4-42bd-b607-74031eaec207') {return 'Master'}
    else if (id == '5db4dcd5-5b54-4149-9862-72d32332beaf') {return 'Guest'}
    else if (id == '77f8a431-6fb7-42e4-a559-abc4ffdc6247') {return 'Kaashvi'}
    else if (id == '8ef74b15-aa87-4c44-bbc5-d671877660b5') {return 'Den'}
    else if (id == 'b9aa89d4-f40d-448d-ac6f-4a3c6068bccd') {return 'Office'}
    else if (id == 'd894faf9-56a5-4c91-a4c5-51c16a90f3aa') {return 'Lawn'}
    else if (id == 'e721d20b-8823-44e7-ab85-703597be14cc') {return 'LivingRoom'}
    else if (id == 'eb15d698-ba65-46ae-a377-8cee7ebbf9fc') {return 'Roohi'}
    else {return 'Unknown'}    
}